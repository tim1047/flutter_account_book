...
class InvestChart extends StatelessWidget {
  const InvestChart({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Dropdown(),
            Consumer<Date>(
              builder: (_, date, __) => InvestChartBody(),
            ),
          ],
...
class InvestChartBody extends StatefulWidget {
  const InvestChartBody({Key? key}) : super(key: key);

  @override
  State<InvestChartBody> createState() => _InvestChartBodyState();
}
              ...
              Card(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      (curExpensePrice - prevExpensePrice > 0 ? ' 더' : ' 덜') + ' 투자했어요'
                    )
                  ]
                )
              ),
